...
??? note  "Vertex Colour Tool Shelf Image - Shelf Button Info"
    ...
    [![Batch Export](../Vertex%20Colours%20Tool/images/vertex_colors_icon.png)](../Vertex%20Colours%20Tool/images/vertex_colors_icon.png){: .md-button download="Vertex_Colour_Tool_Image.png" }

...
Use the <span style="color:lime">dropdown</span> to choose between different file types *(.fbx, .ma, .mb, .obj)*.

The tool also allows to export objects as a  <span style="color:lime">single file</span>.
...
<span style="color:pink">Additional features include</span> :
